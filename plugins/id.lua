...
local function info_chat_1 (cb_extra, success, result)
	...
	text = text..'🎫 '..lang_text(chat_id, 'adminName')..': '..result.print_name:gsub("_", " ")..'\n\n🆔 '..lang_text(chat_id, 'adminId')..': '..result.peer_id..'\n\n'..'🚹 '..lang_text(chat_id, 'adminUsername')..': '..ousername..'\n\n'
	if chat_type == 'chat' then
